...
pub static STD_FILES: LazyLock<Vec<StdFile>> = LazyLock::new(|| {
    ...
    let data: Vec<(&[&str], &[u8])> = vec![
        ...
        (&["format", "tests"], include_bytes!("../../../std/format/tests.sdg")),
        (&["int"], include_bytes!("../../../std/int.sdg")),
        (&["int", "cmp"], include_bytes!("../../../std/int/cmp.sdg")),
        (&["int", "convert"], include_bytes!("../../../std/int/convert.sdg")),
        (&["int", "convert", "string_tests"], include_bytes!("../../../std/int/convert/string_tests.sdg")),
        (&["int", "func"], include_bytes!("../../../std/int/func.sdg")),
        (&["int", "func", "isqrt_tests"], include_bytes!("../../../std/int/func/isqrt_tests.sdg")),
        (&["int", "op"], include_bytes!("../../../std/int/op.sdg")),
        (&["int", "op", "div_tests"], include_bytes!("../../../std/int/op/div_tests.sdg")),
        (&["int", "op", "euclid_tests"], include_bytes!("../../../std/int/op/euclid_tests.sdg")),
        (&["int", "op", "tests"], include_bytes!("../../../std/int/op/tests.sdg")),
        ...
        (&["scalar", "cmp"], include_bytes!("../../../std/scalar/cmp.sdg")),
        (&["scalar", "convert"], include_bytes!("../../../std/scalar/convert.sdg")),
        (&["scalar", "op"], include_bytes!("../../../std/scalar/op.sdg")),
        (&["string"], include_bytes!("../../../std/string.sdg")),
        (&["time"], include_bytes!("../../../std/time.sdg")),
