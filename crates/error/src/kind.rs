...
error_kinds!(
    ...
    (NotStruct { id: Option<IdentWithOrigin> },                      375,    Error),
    (NotPolyGeneric { id: Option<IdentWithOrigin> },                 380,    Error),
    ...
    // to string.
    (UnexpectedType { expected: String, got: String },               385,    Error),
    (CannotInferType { id: Option<InternedString> },                 390,    Error),
    (PartiallyInferedType { id: Option<InternedString>, r#type: String },    395,    Error),
    (CannotInferGenericType { id: Option<String> },                  400,    Error),
    (PartiallyInferedGenericType { id: Option<String>, r#type: String },     405,    Error),
    (CannotApplyInfixOp { op: InfixOp, arg_types: Vec<String> },     410,    Error),
    (CannotSpecializePolyGeneric { num_candidates: usize },          415,    Error),

    (MultipleModuleFiles { module: ModulePath, found_files: Vec<String> },    420,    Error),
    (ModuleFileNotFound { module: ModulePath, candidates: Vec<String> },      425,    Error),
    (LibFileNotFound,                                                430,    Error),
