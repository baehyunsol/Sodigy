...
intrinsics!(
    (NegInt          , "built_in.neg_int"           , 0    , 2   , Fn      ),
    ...
    (ShrInt          , "built_in.shr_int"           , 9    , 2   , Fn      ),
    (ShlInt          , "built_in.shl_int"           , 10   , 2   , Fn      ),
    (Ilog2Int        , "built_in.ilog2_int"         , 11   , 1   , Fn      ),
    (LtScalar        , "built_in.lt_scalar"         , 12   , 2   , Fn      ),
    (EqScalar        , "built_in.eq_scalar"         , 13   , 2   , Fn      ),
    (GtScalar        , "built_in.gt_scalar"         , 14   , 2   , Fn      ),
    (BitAndScalar    , "built_in.bit_and_scalar"    , 15   , 2   , Fn      ),
    (BitOrScalar     , "built_in.bit_or_scalar"     , 16   , 2   , Fn      ),
    (ScalarToInt     , "built_in.scalar_to_int"     , 17   , 1   , Fn      ),
    (IntToScalar     , "built_in.int_to_scalar"     , 18   , 1   , Fn      ),
    (IndexList       , "built_in.index_list"        , 19   , 2   , Fn      ),
    (LenList         , "built_in.len_list"          , 20   , 1   , Fn      ),
    (SliceList       , "built_in.slice_list"        , 21   , 3   , Fn      ),
    (SliceRightList  , "built_in.slice_right_list"  , 22   , 2   , Fn      ),
    (AppendList      , "built_in.append_list"       , 23   , 2   , Fn      ),
    (PrependList     , "built_in.prepend_list"      , 24   , 2   , Fn      ),
    (Exit            , "built_in.exit"              , 25   , 0   , Proc    ),
    (Panic           , "built_in.panic"             , 26   , 0   , Fn      ),
    (Print           , "built_in.print"             , 27   , 1   , NdetProc),
    (EPrint          , "built_in.eprint"            , 28   , 1   , NdetProc),
    (RandomInt       , "built_in.random_int"        , 29   , 0   , NdetFn  ),
    (Sleep           , "built_in.sleep"             , 30   , 1   , Proc    ),
    (Nop             , "built_in.nop"               , 31   , 0   , Fn      ),
//   ^^^               ^^^^^^^^^^^^^^                 ^^     ^     ^^
//   |                 |                              |      |     |
//  (0)               (1)                            (2)    (3)   (4)
//
