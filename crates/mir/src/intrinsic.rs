...
intrinsics!(
    ...
    (AddScalar       , "built_in.add_scalar"        , 14   , 2   , Fn      ),
    (SubScalar       , "built_in.sub_scalar"        , 15   , 2   , Fn      ),
    (MulScalar       , "built_in.mul_scalar"        , 16   , 2   , Fn      ),
    (DivScalar       , "built_in.div_scalar"        , 17   , 2   , Fn      ),
    (RemScalar       , "built_in.rem_scalar"        , 18   , 2   , Fn      ),
    (LtScalar        , "built_in.lt_scalar"         , 19   , 2   , Fn      ),
    (EqScalar        , "built_in.eq_scalar"         , 20   , 2   , Fn      ),
    (GtScalar        , "built_in.gt_scalar"         , 21   , 2   , Fn      ),
    (BitAndScalar    , "built_in.bit_and_scalar"    , 22   , 2   , Fn      ),
    (BitOrScalar     , "built_in.bit_or_scalar"     , 23   , 2   , Fn      ),
    (ScalarToInt     , "built_in.scalar_to_int"     , 24   , 1   , Fn      ),
    (IntToScalar     , "built_in.int_to_scalar"     , 25   , 1   , Fn      ),
    (IndexList       , "built_in.index_list"        , 26   , 2   , Fn      ),
    (LenList         , "built_in.len_list"          , 27   , 1   , Fn      ),
    (SliceList       , "built_in.slice_list"        , 28   , 3   , Fn      ),
    ...
    (Print           , "built_in.print"             , 34   , 1   , Fn      ),
    (EPrint          , "built_in.eprint"            , 35   , 1   , Fn      ),
