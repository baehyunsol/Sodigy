...
intrinsics!(
    ...
    (BitAndScalar    , "built_in.bit_and_scalar"    , 15   , 2),
    (BitOrScalar     , "built_in.bit_or_scalar"     , 16   , 2),
    (ScalarToInt     , "built_in.scalar_to_int"     , 17   , 1),
    (IntToScalar     , "built_in.int_to_scalar"     , 18   , 1),
    (IndexList       , "built_in.index_list"        , 19   , 2),
    (LenList         , "built_in.len_list"          , 20   , 1),
    (SliceList       , "built_in.slice_list"        , 21   , 3),
    (SliceRightList  , "built_in.slice_right_list"  , 22   , 2),
    (AppendList      , "built_in.append_list"       , 23   , 2),
    (PrependList     , "built_in.prepend_list"      , 24   , 2),
    (Exit            , "built_in.exit"              , 25   , 0),
    (Panic           , "built_in.panic"             , 26   , 0),
