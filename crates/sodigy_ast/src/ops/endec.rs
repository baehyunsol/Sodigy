...
impl Endec for InfixOp {
    fn encode(&self, buf: &mut Vec<u8>, session: &mut EndecSession) {
        match self {
            ...
            InfixOp::Index => { buf.push(18); },
            InfixOp::Concat => { buf.push(19); },
            InfixOp::Append => { buf.push(20); },
            InfixOp::Prepend => { buf.push(21); },
